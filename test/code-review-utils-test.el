...
(describe "URL PARSE"
  ...
  (it "given a valid Gitlab URL of a PR returns an PR-ALIST"
    (expect (code-review-utils-pr-from-url "https://gitlab.eng.vmware.com/code-review-experiment/default/-/merge_requests/1")
            :to-equal (a-alist
                       'num "1"
                       'repo "default"
                       'owner "code-review-experiment"
                       'forge 'gitlab
                       'url "https://gitlab.eng.vmware.com/code-review-experiment/default/-/merge_requests/1")))
  (it "given a valid Gitlab URL with subgroup of a PR returns an PR-ALIST"
    (expect (code-review-utils-pr-from-url "https://gitlab.eng.vmware.com/owner/group/subgroup/project/-/merge_requests/1")
            :to-equal (a-alist
                       'num "1"
                       'repo "group%2Fsubgroup%2Fproject"
                       'owner "owner"
                       'forge 'gitlab
                       'url "https://gitlab.eng.vmware.com/owner/group/subgroup/project/-/merge_requests/1")))
  (it "given a valid Gitlab URL with subgroups nested of a PR returns an PR-ALIST"
    (expect (code-review-utils-pr-from-url "https://gitlab.eng.vmware.com/owner/group/subgroup1/subgroup2/subgroup3/project/-/merge_requests/1")
            :to-equal (a-alist
                       'num "1"
                       'repo "group%2Fsubgroup1%2Fsubgroup2%2Fsubgroup3%2Fproject"
                       'owner "owner"
                       'forge 'gitlab
                       'url "https://gitlab.eng.vmware.com/owner/group/subgroup1/subgroup2/subgroup3/project/-/merge_requests/1"))))
